...
insert into prices(brand_id, rate_id, product_id) values(1, 1, 354551);
insert into prices(brand_id, rate_id, product_id) values(1, 2, 354551);
insert into prices(brand_id, rate_id, product_id) values(1, 3, 354551);
insert into prices(brand_id, rate_id, product_id) values(1, 4, 354551);
