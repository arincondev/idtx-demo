...
insert into prices(brand_id, rate_id, product_id, creation_date) values(1, 1, 35455, NOW());
insert into prices(brand_id, rate_id, product_id, creation_date) values(1, 2, 35455, NOW());
insert into prices(brand_id, rate_id, product_id, creation_date) values(1, 3, 35455, NOW());
insert into prices(brand_id, rate_id, product_id, creation_date) values(1, 4, 35455, NOW());
